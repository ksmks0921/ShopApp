...
open class CityPickerViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @objc func selectCityPickerView(_ sender: UIButton!) {
    ...
    @objc func closeCityPickerView(_ sender: UIButton!) {
...
//MARK: Extension Picker Delegate
    ...
    open func pickerView(_ pickerView: UIPickerView, attributedTitleForRow row: Int, forComponent component: Int) -> NSAttributedString? {
        ...
        if component == 0 {
            ...
            let myTitle = NSAttributedString(string: titleData, attributes: [NSAttributedString.Key.font:UIFont(name: "HelveticaNeue-Bold", size: 15.0)!,NSAttributedString.Key.foregroundColor:UIColor.white])
            return myTitle
        } else {
